    ...
    },
    {
      ...
      'conditions': [
        ['tizen==0 or tizen_mobile==0', {
          ...
          'link_settings': {
            'ldflags': [
              '<!@(<(pkg-config) --libs-only-L --libs-only-other murphy-common murphy-resource murphy-glib)',
            ],
            'libraries': [
              '<!@(<(pkg-config) --libs-only-l murphy-common murphy-resource murphy-glib)',
            ],
          },
        }],
      ],
